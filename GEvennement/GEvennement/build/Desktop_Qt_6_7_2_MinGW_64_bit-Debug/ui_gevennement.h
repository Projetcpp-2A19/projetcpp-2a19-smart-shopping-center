...
"}"));
        ...
        line_CAPACITEevent->setGeometry(QRect(40, 300, 191, 26));
...
"}"));
        ...
        line_IDevent->setGeometry(QRect(40, 10, 191, 26));
...
"}"));
        ...
        line_LOCATIONevent->setGeometry(QRect(30, 240, 191, 26));
...
"}\n"
""));
        frame_gestions->setFrameShape(QFrame::Shape::NoFrame);
...
""));
        ...
        frame_3->setGeometry(QRect(170, 0, 871, 31));
...
"}"));
    ...
    void retranslateUi(QMainWindow *GEvennement)
    {
        ...
        comboBox_LOC->setPlaceholderText(QCoreApplication::translate("GEvennement", "       Choisir Un Locataire", nullptr));
