...
public:
    ...
    QDateTimeEdit *date_Debut;
    QLabel *label;
    QLabel *label_2;
    QDateTimeEdit *date_fin;
...
"    selection-background-color: darkgray;\n"
"}"));
        date_Debut = new QDateTimeEdit(frame);
        date_Debut->setObjectName("date_Debut");
        date_Debut->setGeometry(QRect(40, 320, 191, 31));
        date_Debut->setMaximumSize(QSize(16777215, 16777215));
        date_Debut->setStyleSheet(QString::fromUtf8("QDateTimeEdit  {\n"
"	font: 8pt \"Segoe UI\";\n"
"    border: 2px solid gray;\n"
"    border-radius: 10px;\n"
"    padding: 0 8px;\n"
...
"}"));
        ...
        label->setGeometry(QRect(40, 289, 91, 31));
        label_2 = new QLabel(frame);
        label_2->setObjectName("label_2");
        label_2->setGeometry(QRect(40, 349, 91, 31));
        date_fin = new QDateTimeEdit(frame);
        date_fin->setObjectName("date_fin");
        date_fin->setGeometry(QRect(40, 380, 191, 31));
        date_fin->setMaximumSize(QSize(16777215, 16777215));
        date_fin->setStyleSheet(QString::fromUtf8("QDateTimeEdit  {\n"
"	font: 8pt \"Segoe UI\";\n"
"    border: 2px solid gray;\n"
"    border-radius: 10px;\n"
"    padding: 0 8px;\n"
