...
void dashboard::on_pushButton_Services_clicked()
{
    gemploye temp;
    if (temp.authentifierUtilisateur("Responsable services")) {
        MainWindow *mainWindow = new MainWindow(this);  // nom de variable avec minuscule recommandé
        mainWindow->show();
    }
}
