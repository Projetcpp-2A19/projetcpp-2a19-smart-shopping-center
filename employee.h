...
{
private:
    QString ID_EMP, EMAIL, NOM, POSTE, EMBAUCHE, MDP;
...
public:
    ...
    Employee(QString id, int salaire, QString email, QString nom, int telephone, QString poste, QString embauche, QString mdp )
    {
        ID_EMP = id;
        SALAIRE = salaire;
        EMAIL = email;
